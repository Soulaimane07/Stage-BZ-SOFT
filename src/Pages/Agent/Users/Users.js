                            ...
                            {data?.map((item,key)=>(
                              <tr key={key} class="bg-white border-b text-gray-600">
                                  ...
                                  <td class="px-6 py-4 text-center">
                                        {item.type === "agent" &&
                                            <span class="bg-yellow-100 text-yellow-800 text-xs font-medium mr-2 px-4 py-1.5 rounded dark:bg-yellow-700 dark:text-yellow-200">{item.type}</span>
                                        }
                                        {item.type === "company" &&
                                            <span class="bg-red-100 text-red-800 text-xs font-medium mr-2 px-4 py-1.5 rounded dark:bg-red-800 dark:text-red-200">{item.type}</span>
                                        }
                                        {item.type === "client" &&
                                            <span class="bg-green-100 text-green-800 text-xs font-medium mr-2 px-4 py-1.5 rounded dark:bg-green-800 dark:text-green-200">{item.type}</span>
                                        }
                                  </td>
